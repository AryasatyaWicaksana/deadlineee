...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentPage === 'index.html' || currentPage === '' || currentPage === '/') {
        initLandingPage();
    } else if (currentPage === 'Login-page/login.html') {
        initLoginPage();
    } else if (currentPage === 'Login-page/register.html') {
        initRegisterPage();
    } else if (currentPage === 'Login-page/forgot-password.html') {
    ...
    function initLoginPage() {
        ...
        if (forgotPasswordLink) {
            forgotPasswordLink.addEventListener('click', function(e) {
                e.preventDefault();
                window.location.href = 'Login-page/forgot-password.html';
            });
        }
